...
%  rise1 set to 1*step as default 
...
%ungroup from the dct format to the dwt format
n = 3
Yq = dwtgroup(Zq,-n)
...
size_A = 2^(8-n)
t=1:size_A 
Yq(t,t) = quant2(Yq(t,t),qstep(1,n+1),qstep(1,n+1))

%for the other high pass images 
for i = n:-1:1
    size_A = 2^(8-i)
    t=1:size_A 
    Yq(size_A+t,t) = quant2(Yq(t+size_A,t),qstep(1,i),qstep(1,i))
    Yq(t,t+size_A) = quant2(Yq(t,t+size_A),qstep(2,i),qstep(2,i))
    Yq(size_A+t,t+size_A) = quant2(Yq(t+size_A,t+size_A),qstep(3,i),qstep(3,i)) 
end
