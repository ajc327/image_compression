function Z = jpegdec_table(vlc, qstep,rise1, N, M, reptable, bits, huffval, dcbits, W, H)
% JPEGDEC_table Decodes a (simplified) JPEG bit stream to an image using a
% quantistionn table
%
%
%
...
%  regrouped.
%rep table is the repeated quantisation table (256 by 256)
